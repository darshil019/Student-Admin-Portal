...
public class Day extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String dayeditUrl = "Dayaction?tid=" + tid + "&day=" + day + "&lec1=" + lec1 + "&teacher1=" + teacher1 + "&time1=" + time1 + "&lec2=" + lec2 + "&teacher2=" + teacher2 + "&time2=" + time2 + "&lec3=" + lec3 + "&teacher3=" + teacher3 + "&time3=" + time3 ;
        ...
        out.println("<a href='" + dayeditUrl + "'>Edit Day</a>");
        out.println("</div>");
        out.println("</body>");
        out.println("</html>");
    }
